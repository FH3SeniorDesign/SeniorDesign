...
/* Something's wack in here and I can't figure out why but the regular js version works fine so whatever
 * I've never used TypeScript before LMAO
*/
...
export default class CameraTest extends React.Component {
  ...
  getPermissionAsync = async () => {
    ...
    this.setState({ hasPermission: status.granted == true });
  }
