// Reference: https://github.com/tensorflow/examples/blob/master/lite/examples/image_segmentation/ios/ImageSegmentation/TFLiteExtension.swift
...
private enum Constant {
  ...
  static let imageMean: Float32 = 0
  static let imageStd: Float32 = 255
}
